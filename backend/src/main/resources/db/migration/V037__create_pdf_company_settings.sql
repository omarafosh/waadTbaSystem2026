...
-- Unique partial index for singleton default (only one is_default=true allowed)
CREATE UNIQUE INDEX uq_pdf_settings_default ON pdf_company_settings(is_default) 
