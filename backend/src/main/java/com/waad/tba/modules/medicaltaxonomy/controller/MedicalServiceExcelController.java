...
@Slf4j
@RestController
@RequestMapping("/api/medical-services/import")
...
public class MedicalServiceExcelController {
     ...
     */
    @GetMapping("/template")
    @PreAuthorize("hasRole('SUPER_ADMIN') or hasRole('INSURANCE_ADMIN') or hasRole('ADMIN') or hasAuthority('medical_services.create') or hasAuthority('medical_services.import')")
    @Operation(
