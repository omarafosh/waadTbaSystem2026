...
public class MemberMapper {
    ...
    public MemberResponseDto toResponseDto(Member entity) {
        ...
        return MemberResponseDto.builder()
                .id(entity.getId())
                .employerId(entity.getEmployerOrganization() != null ? entity.getEmployerOrganization().getId() : null)
                .employerName(entity.getEmployerOrganization() != null ? entity.getEmployerOrganization().getName() : null)
