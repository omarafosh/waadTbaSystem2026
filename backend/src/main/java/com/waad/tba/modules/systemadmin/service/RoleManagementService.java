...
public class RoleManagementService {
    ...
    public List<RoleViewDto> getAllRoles() {
        ...
        return roles.stream()
                .map(role -> toViewDto(role, roleCounts.getOrDefault(role.getId(), 0L)))
    ...
    public RoleViewDto getRoleById(Long id) {
        ...
        return toViewDto(role, userRepository.countByRolesId(role.getId()));
    }
    ...
    public RoleViewDto createRole(RoleCreateDto dto, String createdBy) {
        ...
        return toViewDto(saved, userRepository.countByRolesId(saved.getId()));
    }
    ...
    public RoleViewDto updateRole(Long id, RoleUpdateDto dto, String updatedBy) {
        ...
        return toViewDto(updated, userRepository.countByRolesId(updated.getId()));
    }
