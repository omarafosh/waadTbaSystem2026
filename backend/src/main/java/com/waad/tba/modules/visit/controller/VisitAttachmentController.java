...
public class VisitAttachmentController {
    ...
    @PreAuthorize("hasAnyAuthority('VISIT_CREATE', 'VISIT_UPDATE', 'ADMIN')")
    ...
    @PreAuthorize("hasAnyAuthority('VISIT_VIEW', 'ADMIN')")
    ...
    @PreAuthorize("hasAnyAuthority('VISIT_UPDATE', 'VISIT_DELETE', 'ADMIN')")
