...
public interface VisitRepository extends JpaRepository<Visit, Long> {
    ...
    @Query("SELECT v FROM Visit v LEFT JOIN FETCH v.provider p WHERE v.member.employerOrganization.id = :employerId")
    ...
    @Query(value = "SELECT v FROM Visit v " +
           ...
           countQuery = "SELECT COUNT(v) FROM Visit v JOIN v.member m WHERE v.member.employerOrganization.id = :employerId AND (" +
           "LOWER(v.doctorName) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(v.specialty) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(v.diagnosis) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(m.fullName) LIKE LOWER(CONCAT('%', :q, '%')))")
    ...
    @Query(value = "SELECT v FROM Visit v " +
           ...
           "LOWER(v.diagnosis) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(m.fullName) LIKE LOWER(CONCAT('%', :q, '%'))",
           countQuery = "SELECT COUNT(v) FROM Visit v JOIN v.member m WHERE LOWER(v.doctorName) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(v.specialty) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(v.diagnosis) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(m.fullName) LIKE LOWER(CONCAT('%', :q, '%'))")
    ...
    @Query(value = "SELECT v FROM Visit v LEFT JOIN FETCH v.member m LEFT JOIN FETCH v.provider p WHERE v.providerId = :providerId",
    ...
    @Query(value = "SELECT v FROM Visit v " +
           ...
           "LOWER(v.diagnosis) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(m.fullName) LIKE LOWER(CONCAT('%', :q, '%')))",
           countQuery = "SELECT COUNT(v) FROM Visit v JOIN v.member m WHERE v.providerId = :providerId AND (" +
           "LOWER(v.doctorName) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(v.specialty) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(v.diagnosis) LIKE LOWER(CONCAT('%', :q, '%')) OR " +
           "LOWER(m.fullName) LIKE LOWER(CONCAT('%', :q, '%')))")
