...
public class UserService {
    ...
    public Page<UserResponseDto> findAllPaginated(Pageable pageable) {
        ...
        List<UserResponseDto> responseDtos = userMapper.toResponseDtos(usersPage.getContent());
        return new org.springframework.data.domain.PageImpl<>(responseDtos, pageable, usersPage.getTotalElements());
    }
