...
public class UserService {
    ...
    public List<UserResponseDto> findAll() {
        ...
        // ⚡ Bolt: Use batching mapper to prevent N+1 queries for employer and provider names
    ...
    public Page<UserResponseDto> findAllPaginated(Pageable pageable) {
        ...
        // ⚡ Bolt: Use batching mapper to prevent N+1 queries for employer and provider names
        List<UserResponseDto> dtoList = userMapper.toResponseDtos(userPage.getContent());
        return new org.springframework.data.domain.PageImpl<>(dtoList, pageable, userPage.getTotalElements());
    }
