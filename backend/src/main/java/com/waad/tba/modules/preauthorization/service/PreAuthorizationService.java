...
public class PreAuthorizationService {
    ...
    public PreAuthorizationResponseDto checkValidity(Long memberId, String serviceCode) {
        ...
        // ⚡ Bolt: Use targeted query instead of O(N) in-memory filtering
        ...
        // Return the most recent valid one (query already sorts by createdAt DESC, so the first one is the most recent)
        PreAuthorization preAuth = validPreAuths.get(0);
