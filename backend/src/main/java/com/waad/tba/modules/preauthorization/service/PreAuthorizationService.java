...
public class PreAuthorizationService {
    ...
    public PreAuthorizationResponseDto checkValidity(Long memberId, String serviceCode) {
        ...
        List<PreAuthorization> validPreAuths = preAuthorizationRepository.findValidForMemberAndService(
        ...
        // Return the most recent valid one (already sorted by createdAt DESC by the query)
        PreAuthorization preAuth = validPreAuths.get(0);
