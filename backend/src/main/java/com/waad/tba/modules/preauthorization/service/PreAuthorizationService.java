...
public class PreAuthorizationService {
    ...
    public PreAuthorizationResponseDto checkValidity(Long memberId, String serviceCode) {
        ...
        List<PreAuthorization> validPreAuths = preAuthorizationRepository.findValidPreAuthsByMemberAndService(
        ...
        // The repository query sorts by createdAt DESC, so index 0 is the most recent
        PreAuthorization preAuth = validPreAuths.get(0);
