...
public class PreAuthorizationService {
    ...
    public PreAuthorizationResponseDto checkValidity(Long memberId, String serviceCode) {
        ...
        List<PreAuthorization> validPreAuths = preAuthorizationRepository.findValidPreAuthorizationsForCheckValidity(
        ...
        // Return the most recent valid one (query already sorts by createdAt DESC)
        PreAuthorization preAuth = validPreAuths.get(0);
