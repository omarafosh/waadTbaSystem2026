                  ...
                  <TableRow key={rule.id} hover>
                      ...
                      <Stack direction="row" spacing={1} alignItems="center">
                        ...
                        <Box>
                          <Typography variant="body2" fontWeight={500}>
                            {rule.label || (rule.ruleType === 'CATEGORY' ? rule.medicalCategoryNameAr : rule.medicalServiceNameAr)}
                          </Typography>
                    ...
                    <TableCell align="center">
                      <RBACGuard
                        ...
                        fallback={
                          rule.active ? <CheckIcon color="success" fontSize="small" /> : <CancelIcon color="disabled" fontSize="small" />
                        }
                      >
                        <Switch
                          checked={rule.active}
