...
const REPORT_CONFIG = {
  ...
  'member-statements': {
    ...
    color: '#ed6c02',
    features: [
      'كشف حساب فردي لكل منتفع',
      'ملخص الاستهلاك السنوي',
      'تفاصيل المطالبات والزيارات',
      'المتبقي من الحد الأقصى'
    ]
  },
  'utilization-reports': {
    ...
    color: '#9c27b0',
    features: [
      'تحليل استخدام الخدمات حسب النوع',
      'مقارنة الاستهلاك بين الشركاء',
      'اتجاهات الاستخدام الشهرية',
      'أعلى الخدمات استخداماً'
    ]
  },
  'financial-analytics': {
    ...
    color: '#0288d1',
    features: [
      'تحليل الربحية حسب الشريك',
      'توقعات المطالبات المستقبلية',
