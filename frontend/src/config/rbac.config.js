...
export const MENU_PERMISSIONS = {
  ...
  // FALLBACK: Allow if user has MANAGE_VISITS (Primary Provider Permission)
  'group-my-services': [PERMISSIONS.VIEW_CLAIM_STATUS, PERMISSIONS.VIEW_PRE_AUTH, PERMISSIONS.MANAGE_VISITS],
  'my-services': [PERMISSIONS.VIEW_CLAIM_STATUS, PERMISSIONS.VIEW_PRE_AUTH, PERMISSIONS.MANAGE_VISITS],
  'provider-claims': [PERMISSIONS.VIEW_CLAIM_STATUS, PERMISSIONS.MANAGE_VISITS],
  'provider-pre-approvals': [PERMISSIONS.VIEW_PRE_AUTH, PERMISSIONS.MANAGE_VISITS],
